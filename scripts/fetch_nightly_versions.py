...
if __name__ == "__main__":
    ...
    add_latest_commit("k4simdelphes", "key4hep/k4SimDelphes",
                         giturl="https://api.github.com/repos/%s/commits/main", date)
    ...
    add_latest_commit("clupatra", "ilcsoft/clupatra", date)
    ...
    add_latest_commit("garlic", "ilcsoft/garlic", date)
    add_latest_commit('k4edm4hep2lcioconv', 'key4hep/k4edm4hep2lcioconv')
    add_latest_commit("k4marlinwrapper", "key4hep/k4marlinwrapper", date)
    add_latest_commit("generalbrokenlines", "GeneralBrokenLines/GeneralBrokenLines", date)
    ...
    add_latest_commit("kaldet", "ilcsoft/kaldet", date)
    ...
    add_latest_commit("lcfivertex", "ilcsoft/lcfivertex", date)
    add_latest_commit("lich", "danerdaner/lich", date)
    add_latest_commit("lccd", "ilcsoft/lccd", date)
    add_latest_commit("lcio", "ilcsoft/lcio", date)
    add_latest_commit("lcgeo", "key4hep/k4geo", date)
    ...
    add_latest_commit("marlintrkprocessors", "ilcsoft/marlintrkprocessors", date)
