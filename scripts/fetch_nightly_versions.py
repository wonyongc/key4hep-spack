...
if __name__ == "__main__":
    ...
    add_latest_commit("clupatra", "ilcsoft/clupatra", date=date)
    ...
    add_latest_commit("garlic", "ilcsoft/garlic", date=date)
    ...
    add_latest_commit("generalbrokenlines", "GeneralBrokenLines/GeneralBrokenLines", date=date)
    ...
    add_latest_commit("kaldet", "ilcsoft/kaldet", date=date)
    ...
    add_latest_commit("lcfivertex", "ilcsoft/lcfivertex", date=date)
    ...
    add_latest_commit("lcgeo", "key4hep/k4geo", date=date)
    ...
    add_latest_commit('marlinkinfitprocessors', 'ilcsoft/marlinkinfitprocessors', date=date)
    add_latest_commit("marlintrkprocessors", "ilcsoft/marlintrkprocessors", date=date)
